			...
			<div class="container-fluid ">
				<div class="row" style="margin-left: 0;margin-top: 10px; margin-right: 1em;">
					<div class="col-sm-6 navbar-left" id="toggle_sidebar" role="navigation">
						<div id="tools">
							<button id="menuButton" type="button" data-toggle="offcanvas" class="btn btn-link glyphicon glyphicon-menu-hamburger" style="float:left"></button>
							
							<a data-toggle="tooltip" id="homebutton" href="../de/index.html" class="btn btn-link glyphicon glyphicon-home"></a>
							<a data-toggle="tooltip" id="listebutton" href="../de/search.html" class="btn btn-link glyphicon glyphicon-book"></a>
							<a data-toggle="tooltip" id="databutton" href="../de/data.html" class="btn btn-link glyphicon glyphicon-dashboard"></a>
