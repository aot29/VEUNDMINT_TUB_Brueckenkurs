...
Further modified by Daniel Haase to use intersite-functions and persistent data.
...
pipwerks.SCORM.API.get = function(){
    ...
    if(API){
        pipwerks.scormdata.API.isFound = true;
    } else {
...
pipwerks.SCORM.API.getHandle = function() {
    ...
    /*
    var API = pipwerks.scormdata.API;
   ...
   // Always search for it (handle is incompatible with intersite)
   // return pipwerks.SCORM.API.get();
