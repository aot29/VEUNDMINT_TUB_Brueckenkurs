...
for vr in variants:
    ...
    p = subprocess.Popen(["python3", "tex2x.py", "VEUNDMINT", "cleanup=0", "dopdf=1", "dotikz=1", "borkify=1", "variant=" + vr, "output=" + vtmp], stdout = subprocess.PIPE, shell = False, universal_newlines = True)
