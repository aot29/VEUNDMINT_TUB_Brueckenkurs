...
\ifttm%
  ...
  type="button" onclick="toggle_hint('MHint}\arabic{MHintCounter}\special{html:');">}\i18n_coshAdd{}\special{html:</button>}
  \special{html:<div class="hintc" style="display:none" id="MHint}\arabic{MHintCounter}\special{html:">
  <div class="coshwarn">}\i18n_coshWarn{}\special{html:</div><br />}
...
\ifnum\value{MExerciseCollectionCounter}=0\else\addtocounter{MExerciseCollectionTextCounter}{1}\special{html:<!-- mexercisetextstart;;}\arabic{MExerciseCollectionTextCounter}\special{html:;; //-->}\fi
  ...
  \textbf{\i18n_exercise{} \MGenerateExNumber
...
%<img src="images/questionmark.png" name="}Name_IMG#2%
...
\newenvironment{MIntro}{\begin{MXContent}{Introduction}{Introduction}{genetisch}\begin{html}<div
...
Formel zu klein? Mit einem Doppelklick auf eine Formel wird sie vergr"o"sert dargestellt.}}
