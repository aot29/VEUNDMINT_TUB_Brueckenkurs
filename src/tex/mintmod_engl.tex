...
\newenvironment{MExercises}{\ifttm\else\clearpage\fi\begin{MXContent}{\i18n_exercises{}}{\i18n_exercises{}}{aufgb}\special{html:<!-- declareexcsymb //-->}}{\end{MXContent}}
...
\special{html:<button name="Name_TESTFINISH" id="TESTFINISH" type="button" onclick="finish_button('}\MTestName\special{html:');" class="testsbutton">\i18n_testSubmit{}</button>}%
\begin{html}
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<button name="Name_TESTRESET" id="TESTRESET" type="button" onclick="reset_button();" class="testsbutton">\i18n_testReset{}</button>
<br />
<br />
<div class="xreply">
