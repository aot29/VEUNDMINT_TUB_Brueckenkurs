...
\special{html:<span class="glyphicon glyphicon-question-sign" id="}QM#3\special{html:"></span>}
%<img class="className="glyphicon-question-sign" src="images/questionmark.png" width="20" height="20"
%border="0" align="absmiddle" id="}QM#3\special{html:"/>} 
\else%
