...
\newcommand{\iCoshAdd}{Weiterführende Inhalte}
\newcommand{\iCoshWarn}{Diese Inhalte liegen über dem Kursniveau und
...
Antwort ein.}
\newcommand{\iTermInputHint}{Klammern Sie Ihre Terme, um eine eindeutige Eingabe zu erhalten. Beispiel: Der Term $\frac{3x+1}{x-2}$ soll in der Form \texttt{(3*x+1)/((x+2)^2)} eingegeben werden (wobei auch Leerzeichen eingegeben werden können, damit eine Formel besser lesbar ist).}
...
\newcommand{\iTestReset}{Test löschen und neu starten}
\newcommand{\iTestEval}{Hier erscheint die Testauswertung!}
\newcommand{\iContents}{Inhalt}
\newcommand{\iModuleOverview}{Modulübersicht}
\newcommand{\iIntroduction}{Einführung}
\newcommand{\iSolution}{L\"osung}
