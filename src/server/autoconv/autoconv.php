...
$bbpassword = "autoconv";
$repo = "https://USERNAME:PASSWORD@bitbucket.org/dhaase/ve-und-mint.git";
$commits = 20;
...
try {
  ...
  chdir("src");
  simple_execute("python3 tex2x.py VEUNDMINT consolecolors=0 consoleascii=1", "Konvertierungsmeldungen");
  chdir("..");
  echo("</p>");
