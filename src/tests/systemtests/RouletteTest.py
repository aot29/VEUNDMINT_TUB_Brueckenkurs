...
class RouletteTest( AbstractSystemTest ):
    ...
    def testRecognizeSolution(self):
        ...
        denominator = self.browser.find_element_by_xpath( denXpath ).text
        ...
        self.assertTrue( "false" in self.browser.find_element_by_id( "QMQFELD_1.2.2.QF1" ).get_attribute( "src" ), "Answer is displaying the wrong image" )
