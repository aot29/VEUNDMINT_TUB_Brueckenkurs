...
class AbstractAnnotator(object):
	...
	def generate(self, *args, **kwargs ):
		...
		Example:
		If you wish to annotate the course with Wikipedia entries, the annotation array will contain
...
class Annotation():
	...
	* Annotations can be links to external sources
	...
	If you wish to add a link to the Wikipedia entry for "Radius" each time the word "circle" is found in the text:
