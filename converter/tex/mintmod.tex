...
\tikzset%
{
  % Defines a custom style which generates BOTH, .png and .pdf export, then deletes the pdf
  png export/.style=%
  { % org = 112.5, Exportierte pngs sind daher leicht groesser, was beim Einbinden des Bilds im HTML auch nicht kompensiert wird
    external/system call/.add={}{; convert -density 175 -transparent
    white "\image.pdf" "\image.png"; rm "\image.log"; rm "\image.dpth"; rm "\image.idx"},
...
\MUGraphicsSolo{\MSectionID\MTIKZautofilename.png}{scale=0.25}{}
}
\else%
