...
\ifttm%
  ...
  <div class="coshwarn">Diese Inhalte gehen über das Kursniveau hinaus und werden in den Aufgaben und Tests nicht abgefragt.</div><br />}
  }{\begin{html}</div>\end{html}\addtocounter{MHintCounter}{1}}
