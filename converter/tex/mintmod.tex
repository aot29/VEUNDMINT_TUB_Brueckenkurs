...
\ifttm
\newenvironment{MSectionStart}{\MSubsubsectionx{Modul\"ubersicht}}{\setcounter{MSSEnd}{0}}
...
\tikzset%
{
  % Defines a custom style which generates pdf andconverts to (low quality) png and svg, then deletes the pdf
  % Important: Do not directly convert from pdf to svg or png with convert as it has some problems
  png export/.style=%
  {
    external/system call/.add={}{; 
      pdf2svg "\image.pdf" "\image.svg" ; 
      convert -density 112.5 -transparent white "\image.svg" "\image.png"; 
      convert -density 450 -transparent white "\image.svg" "\image.4.png"; 
...
\MUGraphicsSolo{\MSectionID\MTIKZautofilename.4.png}{scale=0.25}{width:25\%}
\MRegisterFile{\MSectionID\MTIKZautofilename.png}
...
%\newcommand{\MoIl}{\mbox{}]} % bzw. '('
%\newcommand{\MoIr}{[\mbox{}} % bzw. ')'
\newcommand{\MoIl}[1][]{\mbox{}#1]} % bzw. '('
