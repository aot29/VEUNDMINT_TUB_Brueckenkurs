...
\def\MPageHeaderDef{%
\pagestyle{fancy}%
\fancyhead[r]{(C) MINT-Kolleg Baden-Württemberg 2014}
\fancyfoot[c]{\thepage\\Dieses Material ist urheberrechtlich geschützt}
}
...
% #1 = solution (1 oder 0), #2 = id, #3 = points, #4 = uxid
...
<br />
\end{html}%
\special{html:</div><!-- mfeedbackbutton;Abbildung;}\arabic{MGraphicsCounter}\special{html:;}\arabic{section}.\arabic{subsection}.\arabic{MGraphicsCounter}\special{html:; //-->}%
}
...
\end{html}%
\special{html:</div><!-- mfeedbackbutton;Abbildung;}#1\special{html:;}\MMaterial/\MLastFile\special{html:; //-->}%
}
\else
