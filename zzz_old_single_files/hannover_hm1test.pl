...
output          =>      "hannoverhm1test",      # Zielverzeichnis relativ zur Position der Konfigurationsdatei = Aufrufverzeichnis
source          =>      "module_hannovertest", # Quellverzeichnis relativ zur Position der Konfigurationsdatei = Aufrufverzeichnis
module          =>      "tree_hannover.tex", # tex-Hauptdatei des Kurses (relativ zum Quellverzeichnis!)
...
description     =>      "Eingangstest Höhere Mathematik 1"
