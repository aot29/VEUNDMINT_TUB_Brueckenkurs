...
output          =>      "austauschversion",      # Zielverzeichnis relativ zur Position der Konfigurationsdatei = Aufrufverzeichnis
source          =>      "module_hannovertest", # Quellverzeichnis relativ zur Position der Konfigurationsdatei = Aufrufverzeichnis
module          =>      "tree_austauschtest.tex", # tex-Hauptdatei des Kurses (relativ zum Quellverzeichnis!)
...
description     =>      "austauschversion des Ausgangstests"
