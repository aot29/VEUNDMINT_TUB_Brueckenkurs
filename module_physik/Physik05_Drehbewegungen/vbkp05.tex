...
Aus Modul \MNRef{VBKP03} wissen wir, dass die Geschwindigkeit eines K\"orpers sich aus der \"Anderung seines Aufenthaltsortes relativ zur dazu ben\"otigten Zeit, also der ersten Ableitung der Bahnkurve nach der Zeit ergibt. Ganz analog verfahren wir hier: Da die Bahnkurve im Falle der Drehbewegungen insbesondere vom Drehwinkel $\phi=\phi(t)$ abh\"angt, spielt f\"ur die Momentangeschwindigkeit des Massenpunktes die erste Ableitung des Drehwinkels eine wesentliche Rolle: Es wird f\"ur Kreisbewegungen als Analogie zur Geschwindigkeit die sogenannte Winkelgeschwindigkeit eingef\"uhrt, die ausschlie{\ss}lich die \"Anderung des Winkels mit der Zeit beinhaltet.
...
\begin{MQuestionGroup}
                  ...
                  gr\"o{\ss}ere: \MLCheckbox{0}{DECCONVUXID_4C50DA25_0} 
                  kleinere: \MLCheckbox{0}{DECCONVUXID_4C50DA25_1} 
                  gleiche: \MLCheckbox{1}{DECCONVUXID_4C50DA25_2} 
                  \end{MQuestionGroup}\\
...
\begin{MQuestionGroup}
                  $v_1=v_2$: \MLCheckbox{0}{DECCONVUXID_4C50DA25_3} 
                  $v_1=\frac{1}{2}v_2$: \MLCheckbox{0}{DECCONVUXID_4C50DA25_4} 
                  $v_1=2v_2$: \MLCheckbox{1}{DECCONVUXID_4C50DA25_5} 
                  \end{MQuestionGroup}\\
                  \MGroupButton{Kontrolle}
