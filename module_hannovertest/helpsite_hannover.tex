...
Willkommen zum Eingangstest der Vorlesung Höhere Mathematik 1. Nach Installation können Sie den Test durch Klick auf den Testbutton beginnen:
...
An der Erstellung dieses Tests sind folgende Einrichtungen beteiligt gewesen:
...
\begin{itemize}
\item{Prof. Dr. Reinhard Hochmuth (Hannover)}
\item{Prof. Dr. Wolfram Koepf (Kassel)}
\item{Prof. Dr. Rolf Biehler (Paderborn)}
\item{Prof. Dr. Regina Bruder (Darmstadt)}
\end{itemize}
% Dozenten/Autoren:\\
% \begin{tabular}{lll}
% ? & ? &?
...
und wird durch die \MExtLink{http://www.uni-hannover.de}{Leibniz Universität Hannover} angeboten und rechtlich vertreten.
\ \\ \ \\
Verantwortlich für den Inhalt: Prof. Dr. Reinhard Hochmuth
\ \\ \ \\
