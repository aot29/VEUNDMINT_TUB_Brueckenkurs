...
Intervall $\MoIl 0\MIntvlSep  1\MoIr$ eine negative Zahl von einer positiven Zahl ab, erhalten also durchgehend positive
...
$F: [r_1\MIntvlSep  \infty\MoIr \mbox{} \rightarrow \R, r \mapsto F(r) := -\gamma \cdot \frac{m \cdot M}{r^2}$ 
