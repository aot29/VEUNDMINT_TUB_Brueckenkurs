...
\begin{itemize}
\item{\MNRef{M08A_Stammfunktionen}, \MSRef{M08A_Stammfunktionen}{Stammfunktionen},}
\item{\MNRef{M08A_Integral}, \MSRef{M08A_Integral}{Bestimmtes Integral},}
%\item{\MNRef{M08A_Hauptsatz}, \MSRef{M08A_Hauptsatz}{Hauptsatz der Differential- und Integralrechnung},}
%\item{\MNRef{M08A_Integrationsmethoden}, \MSRef{M08A_Integrationsmethoden}{Methoden zur Berechnung von Integralen},}
\item{\MNRef{M08A_Anwendung}, \MSRef{M08A_Anwendung}{Anwendung zur Fl"achenberechnung},}
\item{\MNRef{VBKM08_Abschlusstest}, \MSRef{VBKM08_Abschlusstest}{Abschlusstest}.}
\end{itemize}
...
Seite durch einen Funktionswert $z_k$ innerhalb des dazu gehörenden 
$x$-Intervalls beschrieben wird. Man bestimmt nun die Flächen dieser 
Rechtecke und summiert diese Teilflächen auf.
...
vier Teile eingeteilt. Dabei sind $x_0 = 1$, $x_1 = 2$, $x_2 = 4$ und $x_3 = 8$. 
...
Prinizipiell kann obiges Vorgehen auch auf Funktionen mit negativen 
...
zu den Voraussetzungen in der nachfolgenden Definiton auf die weiterf"uhrende 
Literatur verwiesen.
...
des Intervalls, sodass $x_{k+1} - x_k$ nennt man
%
\begin{equation}
...
rationale Funktionen, trigonometrische Funktionen und Exponential- und 
Logarithmusfunktionen sowie deren Verkn"upfungen.
