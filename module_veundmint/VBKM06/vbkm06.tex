...
$$
\begin{array}{rrcl}
 f: & \R & \longrightarrow & (0\MIntvlSep  \infty) \\ & x & \longmapsto & f(x) = f_0 \cdot a^{\lambda x}
\end{array}
$$
...
\MDeclareSiteUXID{VBKM06_Exponentialfunktionen_efkt}
 ...
 $$
 \begin{array}{rrcl}
 g: & \R & \longrightarrow & (0\MIntvlSep  \infty) \\ & x & \longmapsto & g(x) = e^x \; \; \; ,
 \end{array}
 $$
 ...
 $$
 \begin{array}{rrcl}
  f: & \R & \longrightarrow & (0\MIntvlSep  \infty) \\ & x & \longmapsto & f(x) = f_0 \cdot e^{\lambda x} \; \; \; ,
 \end{array}
 $$
