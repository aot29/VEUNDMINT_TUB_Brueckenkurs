...
\begin{itemize}
\item{keine Lösung, falls $\Mtfrac14p^2-q<0$ ist (dann darf man die Wurzel nicht ziehen),}
...
$x^2+x=-2$ keine Lösung, denn die quadratische Ergänzung führt auf $x^2+x+\Mtfrac14=-\Mtfrac74$ bzw. $(x+\Mtfrac12)^2=-\Mtfrac74$ mit negativer rechter Seite.
\end{MExample}
