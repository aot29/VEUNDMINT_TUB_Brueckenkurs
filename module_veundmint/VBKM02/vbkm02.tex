...
\ \\ \ \\
\begin{MHint}{Lösung}
Ist $x$ aus dem Intervall $[3;\infty)$, so ist der Term im Betrag nicht negativ und wir erhalten die quadratische Gleichung $x^2-3x-9=0$ mit Lösungsmenge
...
Ist $x$ dagegen aus dem Intervall $(-\infty;3)$, so ist der Term im Betrag negativ. Wir erhalten die normierte quadratische Gleichung $x^2-3x+9=0$.
