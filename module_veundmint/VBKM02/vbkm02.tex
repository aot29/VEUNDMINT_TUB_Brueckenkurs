...
& \Leftrightarrow & t \;=\; \frac{1}{12} \MDFPeriod
\end{eqnarray*}
...
In Mengenschreibweise hat diese Gleichung die Lösungsmenge $\ML=\lbrace 0\MElSetSep \frac19\rbrace$.
\end{MExample}
...
$$
x_{1,2} \;=\; -\frac{p}{2}\pm \sqrt{\frac14p^2-q} \MDFPeriod
$$
...
\begin{eqnarray*}
x_1 &=& \frac12+\sqrt{\frac14+1} \;=\; \frac12(1+\sqrt5) \MDFPSpace ,\ \\
x_2 &=& \frac12-\sqrt{\frac14+1} \;=\; \frac12(1-\sqrt5) \MDFPeriod
\end{eqnarray*}
\end{MExample}
...
$$
x_1 \;=\; s-\sqrt{\frac{d}{a}} \MDFPSpace,\MDFPaSpace x_2 \;=\; s+\sqrt{\frac{d}{a}}
$$
...
\begin{eqnarray*}
x_1 & =& -\frac12-\sqrt{\frac94}\;=\; -2 \MDFPSpace, \\
x_2 & =& -\frac12+\sqrt{\frac94}\;=\; 1 \MDFPSpace,
\end{eqnarray*}
...
\end{itemize}
Die Lösungsmenge ist $\lbrace -\frac85\MElSetSep \frac27\rbrace$.
\end{MHint}
\end{MExercise}
