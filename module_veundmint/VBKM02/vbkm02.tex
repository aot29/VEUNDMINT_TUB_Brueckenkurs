...
\begin{itemize}
\item{dem Abschnitt \MNRef{M02_EinfacheGleichungen}, \MSRef{M02_EinfacheGleichungen}{Einfache Gleichungen},}
%\item{dem Abschnitt \MNRef{M02_Wurzelgleichungen}, \MSRef{M02_Wurzelgleichungen}{Gleichungen mit Wurzeln},}
\item{dem Abschnitt \MNRef{M02_Betragsgleichungen}, \MSRef{M02_Betragsgleichungen}{Betragsgleichungen},}
\item{dem \MSRef{M02_Abschlusstest}{Abschlusstest}, \MNRef{M02_Abschlusstest}.}
\end{itemize}
\end{MSectionStart}
...
\ \\ \ \\
Bestimmung der Lösungen innerhalb der Fälle und Prüfung der Fallbedinungen ergibt die Lösungsmenge \MEquationItem{$\ML$}{\MLParsedQuestion{10}{2,-6}{3}{LVI}} für die Gleichung $|6+3x|=12$.
\begin{MHint}{Lösung}
\begin{eqnarray*}
\ML \;=\; \{-6\MElSetSep 2\}
\end{eqnarray*}
