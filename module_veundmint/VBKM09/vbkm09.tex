...
\begin{itemize}
 \item \textbf{\glqq Zwei Punkte legen eine Gerade eindeutig fest\grqq:} Sind zwei Punkte $P$ und $Q$ im $\R^2$ gegeben, so gibt es genau eine Gerade $g$, welche durch $P$ und $Q$ verläuft. Man schreibt dann auch $g=g_{PQ}=g_{QP}$ oder einfach $g=PQ$ für die Gerade durch $P$ und $Q$.  
...
Gegeben sind die Punkte $P=\MPointTwo{-1}{-1}$ und $Q=\MPointTwo{2}{1}$. Die Gerade $g_{PQ}=PQ$ durch diese beiden Punkte kann direkt gezeichnet werden. Zur Ermittlung der Geradengleichung ist es nützlich die beiden gegebenen Punkte zur Konstruktion eines Steigungsdreiecks zu nutzen: 
  \begin{center}
\MTikzAuto{
\begin{tikzpicture}
%Koordinatensystem
...
\draw[color=red] (3,1.667) node[anchor=west] {$g_{PQ}=PQ$};
%Punkte
\draw [fill=red] (-1,-1) circle (1.5pt);
...
Aus den $x$-Koordinaten $-1$ und $2$ von $P$ und $Q$ ergibt sich die Breite $3$ des Steigungsdreiecks und aus den entsprechenden $y$-Koordinaten $-1$ und $1$ die Höhe $2$. Damit ist die Steigung der Gerade $m=\frac{2}{3}$. Man erhält nun die Geradengleichung von $g_{PQ}$ in Normalform: 
\[
 g_{PQ}\colon\MDFPSpace y=mx+b=\frac{2}{3}x+b\MDFPeriod
\]
Es wird nur noch der Achsenabschnitt $b$ benötigt. Hierfür nutzt man aus, dass $g_{PQ}$ durch die beiden Punkte $P$ und $Q$ verläuft. Man setzt die $x$- und $y$-Koordinaten eines der beiden Punkte in die Geradengleichung ein und berechnet $b$. Benutzt man zum Beispiel den Punkt $Q=\MPointTwo{2}{1}$ erhält man
\[
...
\[
 g_{PQ}\colon\MDFPSpace y=\frac{2}{3}x-\frac{1}{3}\MDFPeriod
\]
\end{MExample}
...
\begin{MExerciseItems}
\item{Gegeben sind die Punkte $A=\MPointTwo{1}{5}$ und $B=\MPointTwo{3}{1}$.\\ $g_{AB}\colon\MDFPSpace y=$\MFunctionQuestion{12}{-2*x+7}{4}{x}{3}} 
\item{Gegeben sind die Punkte $S=\MPointTwo{\MZahl{1}{5}}{-\MZahl{0}{5}}$ und $T=\MPointTwo[\Big]{\frac{3}{2}}{2}$.\\ $g_{ST}\colon\MDFPSpace x=$\MFunctionQuestion{12}{1.5}{4}{x}{3}} 
...
\begin{MHint}{Lösung}
\begin{itemize}
 \item[1.] $g_{AB}\colon\MDFPSpace y=-2x+7$
\begin{center}
 \MTikzAuto{
\begin{tikzpicture}
%Koordinatensystem
...
\draw[color=red] (4,-1) node[anchor=west] {$g_{AB}$};
%Punkte
...
\end{center} 
 ...
 \item[2.] $g_{ST}\colon\MDFPSpace x=\frac{3}{2}$
\begin{center}
 \MTikzAuto{
\begin{tikzpicture}
%Koordinatensystem
...
\draw[color=red] (1.5,3) node[anchor=west] {$g_{ST}$};
%Punkte
