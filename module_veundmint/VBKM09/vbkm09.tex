...
\begin{MXContent}{Koordinatengleichungen für Geraden}{Koordinatengleichungen}{STD}
...
\begin{MInfo}
Für eine Geraden in der Ebene gilt:
\begin{itemize}
 ...
 \item \textbf{\glqq Ein Punkt und eine Steigung legen eine Gerade eindeutig fest\grqq:} Ist ein Punkt $P$ und eine Steigung $m$ gegeben, so gibt es genau eine Gerade $g$. welche durch $P$ verläuft un die Steigung $m$ besitzt.
\end{itemize}
\end{MInfo}
...
Liegen zwei Geradengleichungen allerdings in Normalform vor, kennt man also ihre Steigungen und Achsenabschnitte, so kann man zumindest (ohne Rechnung) direkt eine Aussage darüber treffen welche, der drei relativen Lagebeziehungen aus Infobox \MNRef{info_relative_lage} auf die beiden Geraden zutrifft:
...
\draw[color=blue] (3,-1) node[anchor=west] {$f$};
