...
\begin{MExerciseItems}
\item{Gegeben sind die Punkte $A=\MPointTwo{1}{5}$ und $B=\MPointTwo{3}{1}$.\\ $g_{A B}\colon\MDFPSpace y=$\MLFunctionQuestion{12}{-2*x+7}{4}{x}{3}{VM09X2}} 
\item{Gegeben sind die Punkte $S=\MPointTwo{\MZahl{1}{5}}{-\MZahl{0}{5}}$ und $T=\MPointTwo[\Big]{\frac{3}{2}}{2}$.\\ $g_{S T}\colon\MDFPSpace x=$\MLFunctionQuestion{12}{1.5}{4}{x}{3}{VM09X3}} 
\item{Gesucht ist die Gleichung der Gerade $g$ durch den Punkt $\MPointTwo{-4}{3}$ mit der Steigung $-1$.\\$g\colon\MDFPSpace y=$\MLFunctionQuestion{12}{-1*x-1}{4}{x}{3}{VM09X4}} 
\item{Gesucht ist die Gleichung der Gerade $h$ durch den Punkt $\MPointTwo{42}{2}$ mit der Steigung $0$.\\$h\colon\MDFPSpace y=$\MLFunctionQuestion{12}{2}{4}{x}{3}{VM09X5}} 
\end{MExerciseItems}
...
\begin{MExercise}
\begin{MExerciseItems}
\item{Berechnen Sie den Abstand der beiden Punkte $A=\MPointTwo{-1}{-5}$ und $B=\MPointTwo{4}{7}$.\\ $[\overline{A B}]=$\MLFunctionQuestion{12}{13}{4}{x}{3}{VM09X6}} 
...
\]
gegeben. Sein Mittelpunkt ist $M=$\MLFunctionQuestion{12}{(0,-2)}{4}{x}{3}{VM09X7} und sein Radius lautet $r=$\MLFunctionQuestion{12}{sqrt(8)}{4}{x}{3}{VM09X8}. Zeichnen Sie den Kreis.}  
...
\begin{MQuestionGroup}
\begin{tabular}{ll}
\MLCheckbox{1}{KREIS_COSH1} & berühren sich in einem Punkt,\\
\MLCheckbox{0}{KREIS_COSH2} & schneiden sich in zwei Punkten,\\
\MLCheckbox{0}{KREIS_COSH3} & haben keine gemeinsamen Punkte.
\end{tabular}
\end{MQuestionGroup}
