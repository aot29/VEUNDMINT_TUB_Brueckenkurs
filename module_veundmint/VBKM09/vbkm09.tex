...
Weiterhin werden die oben beschriebenen Koordinatensysteme auch als \MEntry{kartesische Koordinatensysteme}{kartesische Koordinatensysteme} bezeichnet, da ihre Achsen senkrecht aufeinander stehen, sich also im Urpsrung unter einem $90^{\circ}$-Winkel schneiden. Es gibt also auch nicht-kartesische Koordinatensysteme, die in diesem Kurs allerdings nicht betrachtet werden. Deshalb wird im Folgenden oft einfach nur der Begriff Koordinatensystem für ein kartesisches Koordinatensystem benutzt. 
...
In den folgenden Abschnitten sollen nun weitere geometrische Objekte, wie etwa Geraden und Kreise, durch Koordinaten beschrieben werden. Dafür muss man sich zunächst klarmachen, dass Punkte in der Ebene (beschrieben durch ihre Koordinaten bezüglich eines vorgegebenen Koordinatensystems) wieder zu Mengen, sogenannten \MEntry{Punktmengen}{Punktmengen}, zusammengefasst werden können. Dies veranschaulicht das folgende Beispiel:
