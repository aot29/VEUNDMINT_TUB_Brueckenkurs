...
\begin{tabular}{lll}
\MLCheckbox{0}{VEBC11}{VEBC11} & \ \ & Keinen Schnittpunkt,\\
\MLCheckbox{0}{VEBC12}{VEBC12} & \ \ & gleiche Geraden,\\
\MLCheckbox{1}{VEBC13}{VEBC13} & \ \ & einen Schnittpunkt.
\end{tabular}}
\item{$f(x)=1-x$ und $g(x)=4\cdot(3x+1)-x-3$:\\
\begin{tabular}{lll}
\MLCheckbox{0}{VEBC21}{VEBC21} & \ \ & Keinen Schnittpunkt,\\
\MLCheckbox{0}{VEBC22}{VEBC22} & \ \ & gleiche Geraden,\\
\MLCheckbox{1}{VEBC23}{VEBC23} & \ \ & einen Schnittpunkt.
\end{tabular}}
\item{$f(x)=4(x+1)-x-1$ und $g(x)=3x-3$:\\
\begin{tabular}{lll}
\MLCheckbox{1}{VEBC31}{VEBC31} & \ \ & Keinen Schnittpunkt,\\
\MLCheckbox{0}{VEBC32}{VEBC32} & \ \ & gleiche Geraden,\\
\MLCheckbox{0}{VEBC33}{VEBC33} & \ \ & einen Schnittpunkt.
\end{tabular}}
\item{$f(x)=5x-2$ und $g(x)=(2x+1)+(3x-3)$:\\
\begin{tabular}{lll}
\MLCheckbox{0}{VEBC41}{VEBC41} & \ \ & Keinen Schnittpunkt,\\
\MLCheckbox{1}{VEBC42}{VEBC42} & \ \ & gleiche Geraden,\\
\MLCheckbox{0}{VEBC43}{VEBC43} & \ \ & einen Schnittpunkt.
\end{tabular}}
\end{MExerciseItems}
\ \\
...
$$
\sqrt{(3-1)^2+(3-2)^2} \;=\; \sqrt{5} \; \approx\; \MZahl{2}{236}\: .
$$
\end{MExample}
...
\MSetPoints{2}
\begin{tabular}{lll}
\MLCheckbox{0}{VBNT3}{VBNT3} & \ \ & Es gibt keinen Schnittpunkt.\\
\MLCheckbox{1}{VBNT4}{VBNT4} & \ \ & Es gibt genau einen Schnittpunkt.\\
\MLCheckbox{0}{VBNT5}{VBNT5} & \ \ & Die Geraden sind gleich.
\end{tabular}}
\end{MExerciseItems}
\end{MExercise}
...
\MSetPoints{1}
\begin{tabular}{lll}
\MLCheckbox{0}{VBNT7}{VBNT7} & \ \ & Die allgemeine Gleichung kann nicht nach $x$ aufgelöst werden.\\
\MLCheckbox{1}{VBNT8}{VBNT8} & \ \ & Die allgemeine Gleichung kann nicht nach $y$ aufgelöst werden.\\
\MLCheckbox{0}{VBNT9}{VBNT9} & \ \ & Die allgemeine Gleichung ist noch nicht gekürzt.\\
\MLCheckbox{0}{VBNT10}{VBNT10} & \ \ & Die Gerade ist parallel zur $x$-Achse.\\
\MLCheckbox{1}{VBNT11}{VBNT11} & \ \ & Die Gerade ist parallel zur $y$-Achse.\\
\MLCheckbox{1}{VBNT12}{VBNT12} & \ \ & Die Gerade besitzt keine endliche Steigung.\\
\MLCheckbox{0}{VBNT13}{VBNT13} & \ \ &  Die Gerade schneidet die $x$-Achse nicht.\\
\MLCheckbox{0}{VBNT14}{VBNT14} & \ \ &  Die Gleichung beschreibt keine Gerade.
\end{tabular}
\end{MExercise}
...
\MSetPoints{2}
\begin{tabular}{lll}
\MLCheckbox{1}{VBNT15}{VBNT15} & \ \ & Der Ursprung.\\
\MLCheckbox{0}{VBNT17}{VBNT17} & \ \ & $(2;3)$.\\
\MLCheckbox{1}{VBNT16}{VBNT16} & \ \ & $(4;2)$.\\
\MLCheckbox{0}{VBNT18}{VBNT18} & \ \ & $(3;2)$.\\
\MLCheckbox{0}{VBNT19}{VBNT19} & \ \ & $(0;\sqrt{10})$.
\end{tabular}
\end{MExercise}
...
\MSetPoints{1}
\begin{tabular}{lll}
\MLCheckbox{0}{VBNT22}{VBNT22}  & \ \ & in einem Punkt,\\
\MLCheckbox{1}{VBNT23}{VBNT23}  & \ \ & in zwei Punkten,\\
\MLCheckbox{0}{VBNT24}{VBNT24}  & \ \ & in drei Punkten,\\
\MLCheckbox{0}{VBNT25}{VBNT25}  & \ \ & überhaupt nicht.
\end{tabular}
}
\end{MExerciseItems}
\end{MExercise}
