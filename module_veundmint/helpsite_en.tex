...
<p>
<center><button class="stdbutton btn btn-primary btn-lg" type="button" onclick="opensite('sectionx1.1.0.html');">Start the course immediately</button></center>
</p>
<p>or read below about different ways to work with the course. </p>
</div>
}
...
\begin{itemize}
\item{Module 01: \MSRef{VBKM01}{Elementary arithmetic}}
\item{Module 02: \MSRef{VBKM02}{Equations in a single variable}}
\item{Module 03: \MSRef{VBKM03}{Inequalities in a single variable}}
\item{Module 04: \MSRef{VBKM04}{Systems of linear equations}}
\item{Module 05: \MSRef{VBKM05}{Geometry}}
\item{Module 06: \MSRef{VBKM06}{Elementary Functions}}
\item{Module 07: \MSRef{VBKM07}{Differential Calculus}}
\item{Module 08: \MSRef{VBKM08}{Integral Calculus}}
\item{Module 09: \MSRef{VBKM09}{Objects in the Two-Dimensional Coordinate System}}
\item{Module 10: \MSRef{VBKM10}{Basic Concepts of Descriptive Vector Geometry}}
\item{Module 11: \MSRef{VBKM_STOCH}{Language of Descriptive Statistics}}
\end{itemize}
...
Based on the test result you get a recommendation on how to use the online course. </dd>}
...
\end{tabular}
The English language or bilingual version was developed by:
\begin{tabular}{ll}
Ortiz Troncoso, Alvaro & Programmer \\
Plessing, Niklas & Programmer \\
Hummel, Clara & Student Assistent \\
Jesche, Tobias & Student Assistent \\
Hauß, Jella & Coordinator \\
\end{tabular}
...
\end{html}
Prepared using materials of VE\&MINT project by J. Doe, licence \MExtLink{http://creativecommons.org/licenses/by-sa/3.0/de/deed.en}{CC BY-SA 3.0 de}.
\end{center}
\ \\
...
This message can be turned off in the security settings of the browser. <br />
