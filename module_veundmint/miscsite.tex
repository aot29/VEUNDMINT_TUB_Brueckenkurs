...
%
% % <button type="button" id="CREATEBUTTON" style="height:60px;width:250px;background:#D0E0E0" onclick="intersite.usercreatelocal_click(1);">Obige Benutzerdaten im Browser registrieren</button><br />
...
%
% \begin{html}
% <button type="button" class="criticalbutton" id="RESETBUTTON1" onclick="intersite.userreset_click();">Kursdaten zurücksetzen</button>
% \end{html}
