...
Beachten Sie, dass ein einmal registrierter Accountname auch nach Lösung des Accounts nicht mehr für eine Registrierung
zur Verfügung steht.
<br /><br />
...
\begin{html}
<div class="show_noscorm" style="display:none">
<button type="button" class="criticalbutton" id="LOGINBUTTON" onclick="userlogin_click();">Einloggen in den Kurs</button><br />
\end{html}
