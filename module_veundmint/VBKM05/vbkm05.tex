...
\MTikzAuto{%
\tikzsetnextfilename{zentrische_Streckung}
\begin{tikzpicture}[x=1.0cm, y=1.0cm] 
\pgfmathparse{5*sin(44)*cos(77)/sin(59)}\let\cx=\pgfmathresult
\pgfmathparse{5*sin(44)*sin(77)/sin(59)}\let\cy=\pgfmathresult
...
\MTikzAuto{%
\tikzsetnextfilename{Stern_Loesung}
\begin{tikzpicture}
\coordinate (A) at (0,0);
\coordinate (B) at ($ (A) + ( 00:3) $);
\coordinate (C) at ($ (B) + ( 60:3) $);
...
\MTikzAuto{%
\tikzsetnextfilename{Winkelsumme_1}
\begin{tikzpicture}[x=1.0cm, y=1.0cm] 
...
\MTikzAuto{%
\tikzsetnextfilename{Flaecheninhalt_Rechteck}
...
\MTikzAuto{%
\tikzsetnextfilename{DreieckFlaeche_Bsp}
...
\MTikzAuto{%
\tikzsetnextfilename{DreieckFlaeche_Aufgabe}
...
\MTikzAuto{%
\tikzsetnextfilename{Polygone_Parallelogramm}
\begin{tikzpicture}[x=0.5cm, y=0.5cm] 
...
\MTikzAuto{%
\tikzsetnextfilename{Polygone_Parallelogramm_Loesung}
\begin{tikzpicture}[x=0.5cm, y=0.5cm] 
\draw[thick] (0,0) -- (10,0) -- ++(45:10) -- (45:10) -- cycle;
...
\MTikzAuto{%
\tikzsetnextfilename{Polygone_Aufgabe}
\begin{tikzpicture}[x=1.0cm, y=1.0cm] 
...
\MTikzAuto{%
\tikzsetnextfilename{Thaleskreis}
\begin{tikzpicture}[x=1.0cm, y=1.0cm] 
...
\MTikzAuto{%
\tikzsetnextfilename{Thaleskreis_Konstruktion}
\begin{tikzpicture}[x=1.2cm, y=1.2cm] 
...
\MTikzAuto{%
\tikzsetnextfilename{TrigonometrieDefinition_1}
\begin{tikzpicture}[x=1.0cm, y=1.0cm] 
...
\MTikzAuto{%
\tikzsetnextfilename{Trigonometrie_Diagramm}
...
\MTikzAuto{%
\tikzsetnextfilename{Trigonometrie45Grad}
\begin{tikzpicture}[x=1.0cm, y=1.0cm] 
%%\draw[help lines, gray!50, xstep=0.5, ystep=0.5] (0,0) grid (9,8);
...
\MTikzAuto{%
\tikzsetnextfilename{Trigonometrie60Grad}
\begin{tikzpicture}[x=1.0cm, y=1.0cm] 
%%\draw[help lines, gray!50, xstep=0.5, ystep=0.5] (0,0) grid (9,8);
...
\MTikzAuto{%
\tikzsetnextfilename{Trigonometrie_Einheitskreis_a}
...
\MTikzAuto{%
\tikzsetnextfilename{Trigonometrie_Einheitskreis_b}
\begin{tikzpicture}[x=0.024cm, y=2.4cm] 
%Koordinatensystem
\node (xMAX) at (400.0,0){};
\node (yMAX) at (0,1.4){};
...
\MTikzAuto{%
\tikzsetnextfilename{Aufgabe_Einheitskreis}
...
\begin{center}
\MTikzAuto{%
\tikzsetnextfilename{dreieck_einfach}
\begin{tikzpicture}[x=1.0cm, y=1.0cm] 
...
\begin{center}
\MTikzAuto{%
\tikzsetnextfilename{dreieck_haelfte}
\begin{tikzpicture}[x=1.0cm, y=1.0cm] 
