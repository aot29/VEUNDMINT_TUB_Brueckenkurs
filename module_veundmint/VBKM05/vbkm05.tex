...
$1\MEinheit{L"angeneinheit} \hat{=} 2\MEinheit{cm}$ an, und schreiben Sie 
...
Punkt $P_\Mvarphi$ mit den Koordinaten $x_\Mvarphi$ und $y_\Mvarphi$ auf dem 
Einheitskreis.
...
Ergebnis: \MEquationItem{$\Mvarphi$}{\MLParsedQuestion{15}{230}{4}{ExM05Sec6TrigFktWinkel}$\MEinheit{\MGrad}$}
...
\item \MEquationItem{$a$}{\MLParsedQuestion{15}{2.9417}{4}{ExM05Sec6TrigFktWerteLaenge}}
\end{itemize}
