...
\newcommand{\MGeoStrecke}[2]{\ensuremath{[#1#2]}}
...
\begin{MIntro}
\MDeclareSiteUXID{VBKM05_GrundbegriffeIntro}
...
erinnert. Im darauf folgenden Abschnitt werden Winkel gemessen (Bogenma"s und das Gradma"s)
\end{MIntro}

\begin{MXContent}{Punkte und Geraden}{Punkte und Geraden}{STD}
Punkte, Geraden, \ldots sind idealisierte Begriffe.

\begin{MXInfo}{Abstand zwischen Punkten}
\end{MXInfo}
...
Zwei Strahlen (Halbgerade) $g$ und $h$ in der Ebene, die von demselben Punkt $S$
 ausgehen, schlie"sen einen \MEntry{Winkel}{Winkel} ein.
...
\begin{MIntro}
\MDeclareSiteUXID{VBKM05_DreieckIntro}
