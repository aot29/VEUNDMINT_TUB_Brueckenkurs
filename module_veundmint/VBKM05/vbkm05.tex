...
Die Darstellung der Elementaren Geometrie beginnt mit der Einf\"uhrung von 
Winkeln im Bogenma\ss\ und im Gradma\ss\ 
und wird \"uber Stufen- und Wechselwinkel zu den Dreiecken hin fortgesetzt. 
Es werden kongruente und \"ahnliche Dreiecke betrachtet, ihre Fl\"acheninhalte 
und die von anderen Figuren berechnet, worauf man dann zu den Strahlens\"atzen 
kommt, die die Grundlage f\"ur die Einf\"uhrung der trigonometrischen Funktionen
am rechtwinkligen Dreieck bilden. Nachdem man sich auch die Trigonometrie am 
Einheitskreis angesehen hat, wird die dritte Dimension hinzugenommen und es 
werden Volumina von Zylindern, Kegeln und Kugeln behandelt.

Dieses Modul gliedert sich in folgende Abschnitte:

\begin{itemize}
\item{\MNRef{M05_Winkel}, \MSRef{M05_Winkel}{Winkel, Kongruenz und \"Ahnlichkeit},}
\item{\MNRef{M05_Flaecheninhalt}, \MSRef{M05_Flaecheninhalt}{Fl\"acheninhalt und Strahlens\"atze},}
\item{\MNRef{Mathematik_ElementareGeometrie_Sec:Trigonometrie}, \MSRef{Mathematik_ElementareGeometrie_Sec:Trigonometrie}{Trigonometrie},}
...
%\item{\MNRef{M05_Abschlusstest}, \MSRef{M05_Abschlusstest}{Abschlusstest} f\"ur Modul \MNRef{VBKM05}.}
\end{itemize}
...
\MDeclareSiteUXID{VBKM05_Grundbegriffe}
...
\begin{MExerciseItems}
\item \MEquationItem{$V$}{\MLSimplifyQuestion{30}{a*b*c}{10}{a,b,c}{4}{32}{ExM05Zyl2}}
\item \MEquationItem{$O$}{\MLSimplifyQuestion{30}{a*b*c}{10}{a,b,c}{4}{32}{ExM05Zyl3}}
\end{MExerciseItems}
\end{MExerciseItems}
\end{MExercise}
...
Antwort: \MLParsedQuestion{15}{177}{10}{ExM05EK1}
\end{MExercise}
...
Antworten:
\begin{MExerciseItems}
\item \MEquationItem{$d$}{\MLParsedQuestion{15}{177}{10}{ExM05EK21}}
\item \MEquationItem{$V$}{\MLParsedQuestion{15}{177}{10}{ExM05EK22}}
\end{MExerciseItems}
\end{MExercise}
...
\MLParsedQuestion{15}{177}{10}{ExM05EK21c} $\%$
\end{MExerciseItems}
\end{MExercise}
\end{MExercises}
...
\begin{MExercise}
In der folgenden Tabelle sind f\"ur ein rechtwinkliges Dreieck einige Gr\"o{\ss}en gegeben, 
berechnen Sie die \"ubrigen Gr\"o\ss en. Verwenden Sie f\"ur die Winkel stets das Bogenma\ss :\\
...
%Anmerkung: Folgende Angaben beschreiben kein(!) rechtwinkliges Dreieck (jgl):
