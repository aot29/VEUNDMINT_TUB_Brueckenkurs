...
$n \geq 3$ sei.
Hier werden \MEntry{$n$-Ecke}{$n$-Eck} betrachtet, die dadurch entstehne, dass
...
Ein $n$-Eck wird auch als \MEntry{Vieleck}{Vieleck} oder 
...
\begin{itemize}
 \item Die $n$ Punkte, die verbunden werden, hei"sen 
  ...
  \MEntry{Seiten}{Seite ($n$-Eck)} des $n$-Ecks.
...
Seite des $n$-Ecks liegen, hei"sen die \MEntry{Diagonalen}{Diagonale ($n$-Eck)} 
des $n$-Ecks.
\end{itemize}
\end{MXInfo}
...
\MEntry{regelm"a"siges $n$-Eck}{regelm"a"siges $n$-Eck}.
\end{MXInfo}
