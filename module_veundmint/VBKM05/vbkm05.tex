...
%%%\item Frage
%%%\MEquationItem{$u$}{\MLSimplifyQuestion{30}{a*b*c}{10}{a,b,c}{4}{32}{EqIdstringSimpl1}}
%%%\begin{MHint}{L"osung}
%%%\end{MHint}
%%%%
%%%\item Frage
%%%$v = $ \MLSimplifyQuestion{30}{a*b*c}{10}{a,b,c}{4}{32}{EqIdstringSimpl2}
%%%\begin{MHint}{L"osung}
%%%\end{MHint}
%%%%
%%%\end{MExerciseItems}
...
%%%\begin{MExerciseItems}
%%%\item Frage
%%%\MEquationItem{$x$}{\MLParsedQuestion{15}{321}{10}{EqIdstringParsed1}}
%%%\begin{MHint}{L"osung}
%%%\end{MHint}
%%%%
%%%\item Frage
%%%$y = $\MLParsedQuestion{15}{321}{10}{EqIdstringParsed2}
%%%\begin{MHint}{L"osung}
%%%\end{MHint}
%%%%
%%%\end{MExerciseItems}
...
%%%\begin{tabular}{ll}
%%%\MCheckbox{1}{CbIdstring} & Aussage oder Frage \\
%%%\end{tabular}
%%%\end{MQuestionGroup}
%%%\MGroupButton{Eingabe "uberpr"ufen}
%%%\end{MExercise}
%%%
%%%\end{MExercises}
%end of exercises: Uebungen zum Abschnitt Elementare Koerper.
