...
=======
zweiten Punktes $B$ gedanklich immer weiter geht. Ein Strahl wird auch
>>>>>>> master_kit
...
=======
Dies ist eine typische Vorgehensweise in der Geometrie, mit Hilfe von 
Eigenschaften wie einem Abstand neue Objekte zu definieren. Auf diese Weise
>>>>>>> master_kit
...
\begin{tabular}{l*{6}{c}}
 ...
 Bogenma"s & $\pi$               &   \MLParsedQuestion{10}{9*pi/5}{3}{GEO1} &   	$\frac{2 \pi}{3}$                &\MLParsedQuestion{10}{3*pi/2}{3}{GEO2} & $\frac{11 \pi}{12}$ & 
\MLParsedQuestion{10}{pi/6}{3}{GEO3} \\
...
=======
Im rechts dargestellten Vieleck sind alle Winkel gleich, woraus sich ein 
>>>>>>> master_kit
