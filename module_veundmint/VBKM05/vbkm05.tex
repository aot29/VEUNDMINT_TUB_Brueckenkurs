...
%\end{itemize}
%jgl: Bedingung des Parallelogramms folgt aus den anderen Bedingungen:
%\item es ein Parallelogramm ist, in welchem die Diagonalen senkrecht 
...
%
%jgl: Diagonalen halbieren sich und sind gleich lang, was durch den 
%blauen Schnittpunkt angedeutet werden soll:
\draw[color=blue!50!white] (A) -- (C);
\draw[color=blue!50!white] (D) -- (B);
%\draw[color=blue!60!white] (A) -- (S);
%\draw[color=blue!60!white] (S) -- (C);
%\draw[color=blue!60!white] (D) -- (S);
%\draw[color=blue!60!white] (S) -- (B);
...
%
%\draw[color=red!80!yellow] ($ (A) + (10:0.6cm) $) arc(10:100:0.6cm);
\draw[color=red!80!yellow] ($ (A)!0.2!(B) $) arc(10:100:0.5cm);
\draw[color=red!80!yellow] ($ (B)!0.2!(C) $) arc(100:190:0.5cm);
\draw[color=red!80!yellow] ($ (C)!0.2!(D) $) arc(190:280:0.5cm);
\draw[color=red!80!yellow] ($ (D)!0.2!(A) $) arc(280:370:0.5cm);
\filldraw[color=red!50!yellow] ($ (A) + (75:0.3cm) $) circle(0.3pt);
%
\draw[color=green!50!black] (A) -- (B);
\draw[color=green!50!black] (D) -- (C);
\draw[color=green] (A) -- (D);
\draw[color=green] (B) -- (C);
%
\draw[color=blue] (A) -- (C);
\draw[color=blue!60!white] (D) -- (B);
\foreach \Punkt in {(A), (B), (C), (D)} do
\filldraw \Punkt circle(2pt);
\end{scope}
\end{tikzpicture}
