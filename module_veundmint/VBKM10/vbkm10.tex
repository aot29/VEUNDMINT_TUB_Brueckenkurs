...
\[
 g\colon \MVec{r}=x\MVector{1\\\frac{1}{2}}+\MVector{0\\1},\MDFPaSpace x\in\R \MDFPeriod
\]
...
\[
 g=\left\{\MVec{r}=\lambda\MVec{u}+\MVec{a}\in\R^2\MCondSetSep\lambda\in\R\right\},
\]
oft kurz geschrieben als
\[
 g\colon \MVec{r}=\lambda\MVec{u}+\MVec{a},\MDFPSpace\lambda\in\R\MDFPeriod
\]
...
\[
 g\colon \MVec{r}=x\MVector{1\\m}+\MVector{0\\b},\MDFPSpace x\in\R
\]
...
\[
 g\colon \MVec{r}=\lambda\MVec{u}+\MVec{a},\MDFPSpace\lambda\in\R
\]
...
\begin{itemize}
 ...
 \[
  2y-3x=6\MDFPaSpace\Leftrightarrow\MDFPaSpace y=\frac{3}{2}x+3
 \]
 ...
 \[
  g\colon \MVec{r}=x\MVector{1\\\frac{3}{2}}+\MVector{0\\3},\MDFPSpace x\in\R
 \]
 ...
 \[
  g\colon \MVec{r}=\sigma\MVector{2\\3}+\MVector{2\\6},\MDFPSpace \sigma\in\R
 \]
 ...
 \[
  h\colon \MVec{r}=y\MVector{0\\1}+\MVector{2\\0},\MDFPSpace y\in\R
 \]
 gegeben.
 \item Für die Gerade $\alpha$ in Parameterform mit
 \[
  \alpha\colon \MVec{r}=\mu\MVector{-3\\2} + \MVector{1\\1},\MDFPSpace \mu\in\R
 \]
 ...
 \[
  \beta\colon \MVec{r}=\lambda\MVector{0\\-2} + \MVector{-1\\1},\MDFPSpace \lambda\in\R \MDFPSpace ,
 \]
 ...
 \[
  \MVec{u}=\MDVec{P Q}=\MDVec{Q}-\MDVec{P}=\MVector{3\\2}-\MVector{-1\\-1}=\MVector{4\\3} \MDFPSpace ,
 \]
 ...
 Somit gilt
 \[
  P Q\colon \MVec{r}=\lambda\MVector{4\\3}+\MVector{-1\\-1},\MDFPSpace\lambda\in\R \MDFPeriod
 \]
 Bild hierzu:
 \begin{center}
\MTikzAuto{
...
\[
 g\colon \MVec{r}=t\MVector{-1\\5}+\MVector{2\\5},\MDFPSpace t\in\R
\]
...
\[
 h\colon \MVec{r}=s\MVector{a\\2}+\MVector{b\\-5},\MDFPSpace s\in\R \MDFPeriod
\]
...
\begin{MQuestionGroup}
\begin{tabular}{lll}
\MCheckbox{1}{PARA4} & (i) & $A B:\MVec{r}=s\MVector{5\\-\frac{1}{2}}+\MVector{0\\-\frac{6}{5}},\MDFPSpace s\in\R$\\
\MCheckbox{0}{PARA5} & (ii) & $A B:\MVec{r}=t\MVector{5\\\frac{1}{2}}+\MVector{-2\\-1},\MDFPSpace t\in\R$\\
\MCheckbox{1}{PARA6} & (iii) & $A B:\MVec{r}=u\MVector{-5\\\frac{1}{2}}+\MVector{-12\\0},\MDFPSpace u\in\R$\\
\MCheckbox{1}{PARA7} & (iv) & $A B:\MVec{r}=v\MVector{10\\-1}+\MVector{4\\-\frac{8}{5}},\MDFPSpace v\in\R$\\
\MCheckbox{0}{PARA8} & (v) & $A B:\MVec{r}=w\MVector{-1\\10}+\MVector{-22\\1},\MDFPSpace w\in\R$\\
\MCheckbox{0}{PARA9} & (vi) & $A B:\MVec{r}=z\MVector{\frac{5}{2}\\-\frac{1}{4}}+\MVector{\frac{6}{5}\\-1},\MDFPSpace z\in\R$\\
\end{tabular} 
\end{MQuestionGroup}
...
auf der Geraden 
\[
 i\colon \MVec{r}=\tau\MVector{1\\-3}+\MVector{-1\\2},\MDFPSpace\tau\in\R \MDFPSpace ,
\]
...
\[
 \MDVec{A B}=\MDVec{B}-\MDVec{A}=\MVector{3\\-\frac{3}{2}}-\MVector{-2\\-1}=\MVector{5\\-\frac{1}{2}}.
\]
...
\[
 g=\left\{\MVec{r}=\lambda\MVec{u}+\MVec{a}\in\R^3\MCondSetSep\lambda\in\R\right\},
\]
oft kurz geschrieben als
\[
 g\colon \MVec{r}=\lambda\MVec{u}+\MVec{a},\MDFPSpace\lambda\in\R\MDFPeriod
...
\[
 P Q\colon \MVec{r}=t\MVector{3\\2\\\frac{15}{2}}+\MVector{2\\0\\8},\MDFPSpace t\in\R\MDFPeriod
\]
...
\[
 P Q\colon \MVec{r}=s\MVector{-6\\-4\\-15}+\MVector{-1\\-2\\\frac{1}{2}},\MDFPSpace s\in\R
\]
...
hat die Parameterform
\[
 h\colon \MVec{r}=\lambda\MVector{4\\a\\b}+\MVector{c\\d\\-4},\MDFPSpace\lambda\in\R \MDFPeriod
\]
...
auf der Geraden 
\[
 g\colon \MVec{r}=\nu\MVector{1\\-3\\8}+\MVector{-1\\2\\0},\MDFPSpace\nu\in\R \MDFPSpace ,
\]
...
Aus den gegebenen Punkten $A$ und $B$ folgt der Richtungsvektor
\[
 \MDVec{A B}=\MDVec{B}-\MDVec{A}=\MVector{-3\\0\\1}-\MVector{-1\\-1\\0}=\MVector{-2\\1\\1}.
\]
...
\[
 \MVector{4\\-2\\-2} = -2\cdot\MVector{-2\\1\\1}.
\]
...
\[
 h\colon\MVec{r}=t\MVector{-2\\1\\1}+\MVector{-1\\-1\\0},\MDFPSpace t\in\R \MDFPeriod
\]
...
Für Ebenen werden für gewöhnlich Großbuchstaben ($E$, $F$, $G$, ...) als Variablen verwendet. Natürlich ist das Konzept einer Ebene nur im $\R^3$ sinnvoll.
...
\[
 E=\{\MVec{r}=\MVec{a}+\lambda\MVec{u}+\mu\MVec{v}\MCondSetSep \lambda,\mu\in\R\}
\]
oft kurz geschrieben als
\[
 E\colon\MVec{r}=\MVec{a}+\lambda\MVec{u}+\mu\MVec{v};\MDFPSpace \lambda,\mu\in\R.
\]
...
\begin{itemize}
 ...
 \[
  E\colon \MVec{r}=\MVec{a}+\lambda\MVec{u}+\mu\MVec{v}=\MVector{0\\1\\0}+\lambda\MVector{1\\0\\0}+\mu\MVector{0\\0\\1};\MDFPSpace\lambda,\mu\in\R,
 \]
 ...
 \]
 Dieser kann als Aufpunktvektor verwendet werden. Als andere Richtungsvektoren können alle Vektoren verwendet werden die zu $\MVec{u}$ und $\MVec{v}$ komplanar, zu einander aber nicht kollinear sind. Zum Beispiel $\MVec{u}^\prime=\MVector{1\\0\\1}=1\cdot\MVector{1\\0\\0}+1\cdot\MVector{0\\0\\1}$ und $\MVec{v}^\prime=\MVector{1\\0\\-1}=1\cdot\MVector{1\\0\\0}-1\cdot\MVector{0\\0\\1}$. Dann ist eine weiter Darstellung von $E$ in Parameterform durch
 \[
  E\colon \MVec{r}=\MVec{a}^\prime+s\MVec{u}^\prime+t\MVec{v}^\prime=\MVector{1\\1\\1}+s\MVector{1\\0\\1}+t\MVector{1\\0\\-1};\MDFPSpace s,t\in\R,
 \]
 möglich.
 \item Gegeben sind die drei Punkte $A=\MPointThree{1}{0}{-2}$, $B=\MPointThree{4}{1}{2}$ und $C=\MPointThree{0}{2}{1}$. Es ist eine Parameterformen der Ebene $F$ anzugeben, die durch diese drei Punkte festgelegt wird.
 ...
 \[
  \MDVec{A B} = \MDVec{B}-\MDVec{A}=\MVector{4\\1\\2}-\MVector{1\\0\\-2}=\MVector{3\\1\\4},
 \]
 \[
 ...
 Folglich ist
 \[
  F\colon\MVec{r}=\MVector{1\\0\\-2}+\rho\MVector{3\\1\\4}+\sigma\MVector{-1\\2\\3};\MDFPSpace\rho,\sigma\in\R
 \]
...
\[
 g\colon \MVec{r}=\MVector{0\\-1\\0}+t\MVector{2\\0\\-1},\MDFPSpace t\in\R.
\]
...
\[
 \MDVec{Q}_1=\MVector{0\\-1\\0}+0\cdot\MVector{2\\0\\-1}=\MVector{0\\-1\\0}.
\]
Die Wahl $t=1$ führt auf
\[
 \MDVec{Q}_2=\MVector{0\\-1\\0}+1\cdot\MVector{2\\0\\-1}=\MVector{2\\-1\\-1}.
\]
Damit ergeben sich die Richtungvektoren
\[
 \MDVec{P Q}_1=\MDVec{Q}_1 - \MDVec{P} = \MVector{0\\-1\\0} - \MVector{2\\1\\-3} = \MVector{-2\\-2\\3}
\]
und
\[
 \MDVec{P Q}_2=\MDVec{Q}_2 - \MDVec{P} = \MVector{2\\-1\\-1} - \MVector{2\\1\\-3} = \MVector{0\\-2\\2}.
\]
Somit lautet eine Punkt-Richtungsform der Ebene $E$:
\[
 E\colon\MVec{r}=\MVector{2\\1\\-3}+v\MVector{-2\\-2\\3}+w\MVector{0\\-2\\2};\MDFPSpace v,w\in\R.
\]

(Diese Abbildung erscheint in Kürze.)
\end{MExample}

Weitere Lagebeziehungen von Ebenen und Geraden -- sowie daraus abgeleitet weitere Daten mit Hilfe derer eine Ebenen eindeutig festgelegt werden kann -- werden im folgenden Abschnitt \MNRef{VBKM10_Lagebeziehung} untersucht.
...
\[
 E\colon\MVec{r}=\MVector{2\\-3\\x}+s\MVector{y\\1\\-1}+t\MVector{5\\z\\-4};\MDFPSpace s,t\in\R.
\]
...
\[
 \MDVec{A B}=\MDVec{B}-\MDVec{A}=\MVector{3\\-1\\10}-\MVector{0\\0\\8}=\MVector{3\\-1\\2},
\]
\[
...
\[
 \MVector{y\\1\\-1}=a\MVector{3\\-1\\2}+b\MVector{-1\\-2\\3}=\MVector{3a-b\\-a-2b\\2a+3b},
\]
also wiederrum ein lineares Gleichungssystem mit drei Unbekannten. In diesem Fall liefern die zweite und die dritte Komponente die beiden Gleichungen
\[
 1=-a-2b\MDFPaSpace\textrm{und}\MDFPaSpace -1=2a+3b
\]
woraus man $a=1$ und $b=-1$ berechnet. Dies führt auf
\[
 y= 3+ (-1)\cdot(-1)=4.
\]
Völlig analog für den zweiten Vektor:
\[
...
\[
 E\colon\MVec{r}=\MVector{3\\0\\2}+s\MVector{2\\1\\7}+t\MVector{3\\2\\5};\MDFPSpace s,t\in\R\MDFPeriod
\]
...
\[
 \MVec{r}=\MVector{3\\0\\2}+s\MVector{2\\1\\7}+t\MVector{3\\2\\5}=\MVector{3+2s+3t\\s+2t\\2+7s+5t}.
\]
Die Bedingungen 
\[
 \MDVec{P}=\MVec{r}\MDFPSpace\Leftrightarrow\MDFPSpace\MVector{h\\2\\-2}=\MVector{3+2s+3t\\s+2t\\2+7s+5t},
\]
\[
...
\[
 2=s+2t\MDFPaSpace\textrm{und}\MDFPaSpace -4=7s+5t,
\]
...
\[
 -2=2s+3t\MDFPaSpace\textrm{und}\MDFPaSpace 4=7s+5t,
\]
...
Gegeben sind zwei Geraden im Raum in Punkt-Richtungsform, $g$ mit Aufpunktvektor $\MVec{a}$ und Richtungsvektor $\MVec{u}$ sowie $h$ mit Aufpunktvektor $\MVec{b}$ und Richtungsvektor $\MVec{b}$:
\[
 g\colon\MVec{r}=\MVec{a}+s\MVec{u};\MDFPSpace s\in\R,
\]
\[
 h\colon\MVec{r}=\MVec{b}+t\MVec{v};\MDFPSpace t\in\R\MDFPeriod
\]
...
\[
 g\colon\MVec{r}=\MVector{-1\\0\\3}+s\MVector{-2\\2\\-4};\MDFPSpace s\in\R,
\]
\[
 h\colon\MVec{r}=\MVector{1\\-2\\7}+t\MVector{1\\-1\\2};\MDFPSpace t\in\R,
\]
\[
 i\colon\MVec{r}=\MVector{4\\0\\8}+u\MVector{-3\\3\\-6};\MDFPSpace u\in\R
\]
und
\[
 j\colon\MVec{r}=\MVector{1\\3\\2}+v\MVector{1\\3\\-3};\MDFPSpace v\in\R\MDFPeriod
\]
\begin{itemize}
...
\[
  \MVector{-2\\2\\-4}= -2\cdot\MVector{1\\-1\\2}. 
\]
...
\[
 8-6\cdot 1=2-3\cdot 0\MDFPSpace\Leftrightarrow\MDFPSpace 2=2.
\]
...
\[
 -2s=2+v\MDFPaSpace\textrm{und}\MDFPaSpace 2s=3+3v,
\]
...
\[
 3-4(-\frac{3}{8})=2-3(-\frac{5}{4})\MDFPSpace\Leftrightarrow\MDFPSpace \frac{9}{2}=\frac{23}{4}.
\]
...
Die beiden Geraden 
\[
 g\colon\MVec{r}=\MVector{1\\2\\4}+x\MVector{-5\\10\\-15};\MDFPaSpace x\in\R
\]
und
\[
 h\colon\MVec{r}=\MVector{4\\0\\7}+y\MVector{3\\-2\\3};\MDFPaSpace y\in\R
\]
schneiden sich, da 

\begin{MQuestionGroup}
\begin{tabular}{lll}
\MCheckbox{0}{INTER1} & \ & die beiden Richtungsvektoren kollinear sind,\\
\MCheckbox{0}{INTER2} & \ & die beiden Richungsvektoren nicht kollinear sind,\\
\MCheckbox{0}{INTER3} & \ & die beiden Richtungsvektoren kollinear sind und die Geraden einen gemeinsamen Punkt besitzen,\\
\MCheckbox{1}{INTER4} & \ & die beiden Richungsvektoren nicht kollinear sind und die Geraden einen gemeinsamen Punkt besitzen,\\
\MCheckbox{0}{INTER5} & \ & die beiden Richungsvektoren nicht kollinear sind und die Geraden keinen gemeinsamen Punkt besitzen.\\
\end{tabular}
\end{MQuestionGroup}
\MGroupButton{Antworten kontrollieren}
...
\[
 -5x=3+3y\MDFPaSpace\textrm{und}\MDFPaSpace 2+10x=-2y,
\]
woraus man $x=0$ und $y=-1$ berechnet. Setzt man diese Werte in die dritte Komponente ein, so ergibt sich
\[
 4-15\cdot 0=7+3\cdot(-1)\MDFPSpace\Leftrightarrow\MDFPSpace 4=4.
\]
...
Die beiden Geraden
\[
 \gamma\colon\MVec{r}=\MVector{-4\\6\\0}+s\MVector{3\\-2\\-2};\MDFPSpace s\in\R 
\]
und
\[
 \kappa\colon\MVec{r}=\MVector{a\\b\\4}+t\MVector{-\frac{3}{2}\\c\\1};\MDFPSpace t\in\R 
\]
sind parallel. Bestimmen Sie den fehlenden Eintrag $c$ und geben Sie an welche Werte $a$ und $b$ für die Parallelität \textbf{nicht} annehmen dürfen. 
...
\[
 \MVector{-\frac{3}{2}\\c\\1}=s\MVector{3\\-2\\-2},
\]
...
\[
 g\colon\MVec{r}=\MVector{1\\2\\4}+s\MVector{-5\\10\\-15};\MDFPaSpace s\in\R
\]
und
\[
 h\colon\MVec{r}=\MVector{4\\0\\7}+t\MVector{3\\-2\\3};\MDFPaSpace t\in\R
\]
...
\[
 \MDVec{P}=\MVector{1\\2\\4}+1\cdot\MVector{-5\\10\\-15}=\MVector{-4\\12\\-11},
\]
\[
 \MDVec{Q}=\MVector{4\\0\\7}+1\cdot\MVector{3\\-2\\3}=\MVector{7\\-2\\10}.
\]
...
und
\[
 \MDVec{S Q}=\MDVec{Q}-\MDVec{S}= \MVector{7\\-2\\10}-\MVector{1\\2\\4}=\MVector{6\\-4\\11}.
\]
Somit ist eine mögliche Parameterform von $E$ durch
\[
 E\colon \MVec{r}=\MVector{1\\2\\4}+\mu\MVector{-5\\10\\-15}+\nu\MVector{6\\-4\\11};\MDFPaSpace \mu,\nu\in\R
\]
gegeben.

\item Die beiden Geraden
\[
 g\colon\MVec{r}=\MVector{-4\\6\\0}+s\MVector{3\\-2\\-2};\MDFPSpace s\in\R 
\]
und
\[
 h\colon\MVec{r}=\MVector{1\\1\\4}+t\MVector{-\frac{3}{2}\\1\\1};\MDFPSpace t\in\R 
\]
...
\]
dass für den ersten Richtungsvektor $\MDVec{A B}$ der Ebene $F$, genau der Richtungsvektor $\MVector{3\\-2\\-2}$ von $g$ benutzt werden kann. Der zweite Richtungsvektor der Ebene ergibt dich aus dem Ortsvektor eines Punktes $B$ auf $h$ für den Parameterwert $t=0$, also den Aufpunkt von $h$:
\[
 \MDVec{B}=\MVector{1\\1\\4}.
\]
Und folglich ist
\[
...
\[
 F\colon \MVec{r}=\MVector{-4\\6\\0}+\lambda\MVector{3\\-2\\-2}+\mu\MVector{5\\-5\\4};\MDFPaSpace \lambda,\mu\in\R.
\]
...
\[
 g\colon\MVec{r}=\MVec{a}+\lambda\MVec{u};\MDFPaSpace\lambda\in\R
\]
und
\[
 E\colon\MVec{r}=\MVec{b}+\mu\MVec{v}+\nu\MVec{w};\MDFPaSpace\mu,\nu\in\R,
\]
...
\begin{enumerate}
 ...
 \item Die Gerade $g$ liegt und die Ebene $E$ schneiden sich. Dies ist genau dann der Fall, wenn die drei Richtungsvektoren $\MVec{u}$, $\MVec{v}$ und $\MVec{w}$ nicht komplanar sind.
\end{enumerate}
...
Hat man eine Gerade und eine Ebene gegeben und möchte deren Lagebeziehung bestimmen, so überprüft man zunächst die drei Richtungsvektoren auf Komplanarität. Ist diese gegeben untersucht man den Aufpunkt der Geraden daraufhin ob er in der Ebene enthalten ist. Dies legt letztlich einen der drei möglichen Fälle eindeutig fest. Falls sich Gerade und Ebene schneiden, kann man dann noch den Schnittpunkt berechnen. Das folgende Beispiel zeigt einige dafür benutzte Vorgehensweisen.

\begin{MExample}
Gegeben ist eine Ebene $E$ in Parameterform durch
\[
 E\colon\MVec{r}=\MVector{2\\2\\2}+s\MVector{3\\-1\\0}+t\MVector{0\\0\\2};\MDFPaSpace s,t\in\R.
\]
\begin{itemize}
 ...
 \[
  g\colon\MVec{r}=\MVector{-1\\3\\0}+x\MVector{3\\-1\\-4};\MDFPaSpace x\in\R
 \]
 ...
 \]
 Der Ortsevktor $\MVector{-1\\3\\0}$ der Geraden ergibt sich also für die Parameterwerte $s=t=-1$ in der Ebene. Demhingegen ist die Gerade
 \[
  h\colon\MVec{r}=y\MVector{3\\-1\\-4};\MDFPaSpace y\in\R
 \]
 ...
 \[
  k\colon\MVec{r}=\MVector{-3\\1\\0}+\mu\MVector{1\\1\\1};\MDFPaSpace\mu\in\R.
 \]
 ...
 \]
 Interessiert man sich nur für den Schnittpunkt, so genügt es den Parameterwert der Geraden zu bestimmen für den diese Vektorgleichung erfüllt ist. Der Orstvektor des Schnittpunkts ergibt sich dann surch Einsetzen des bestimmten Parameterwerts in die Gerade. Die ersten beiden Komponenten dieser Vektorgleichung liefern zwei Gleichungen für die Unbekannten $\mu$ und $s$:
 \[
  \mu=5+3s\MDFPaSpace\textrm{und}\MDFPaSpace \mu=1-s,
 \]
 woraus man $\mu=2$ erhält. Damit hat der Schnittpunkt den Ortsvektor
 \[
  \MVector{-3\\1\\0}+2\MVector{1\\1\\1}=\MVector{-1\\3\\2}.
 \]
\end{itemize}
\end{MExample}
...
\[
 E\colon\MVec{r}=\MVector{8\\-2\\0}+s\MVector{1\\3\\2}+t\MVector{-1\\1\\-1};\MDFPaSpace s,t\in\R
\]
und die Gerade 
\[
 g\colon \MVec{r}=\MVector{0\\2\\1}+u\MVector{0\\4\\c};\MDFPaSpace u\in\R,
\]
...
\]
ist nur für $c=1$ erfüllbar, denn die erste und zweite Komponenten liefern das lineare Gleichungssystem 
\[
 s-t=0,\MDFPaSpace 3s+t=4
\]
...
\[
 \MVector{0\\2\\1}+u\MVector{0\\4\\c}=\MVector{0\\1+4u\\1+c u}=\MVector{8+s-t\\-2+3s+t\\2s-t}=\MVector{8\\-2\\0}+s\MVector{1\\3\\2}+t\MVector{-1\\1\\-1}\MDFPeriod
\]
...
\[
 h\colon\MVec{r}=\MVector{3\\2\\1}+\rho\MVector{-8\\9\\1};\MDFPaSpace\rho\in\R.
\]
...
\[
 E_1\colon \MVec{r}=\MVec{a}_1+\mu\MVec{u}_1+\nu\MVec{v}_1;\MDFPaSpace\mu,\nu\in\R
\]
und
\[
 E_2\colon \MVec{r}=\MVec{a}_2+\rho\MVec{u}_2+\sigma\MVec{v}_2;\MDFPaSpace\rho,\sigma\in\R.
\]
...
\[
 E\colon\MVec{r}=\MVector{0\\2\\-2}+a\MVector{1\\-2\\1}+b\MVector{4\\0\\-2};\MDFPaSpace a,b\in\R,
\]
\[
 F\colon\MVec{r}=\MVector{5\\1\\0}+c\MVector{5\\-2\\-1}+d\MVector{-3\\-2\\3};\MDFPaSpace c,d\in\R
\]
und
\[
 G\colon\MVec{r}=\MVector{5\\0\\1}+x\MVector{1\\-2\\0}+y\MVector{0\\0\\3};\MDFPaSpace x,y\in\R.
\]
\begin{itemize}
 ...
 \[
  F^{\prime}\colon\MVec{r}=\MVector{0\\2\\-2}+\alpha\MVector{5\\-2\\-1}+\beta\MVector{-3\\-2\\3};\MDFPaSpace \alpha,\beta\in\R
 \]
 eine solche Ebene.
 ...
 \]
 durch keine Zahlen $a$ und $b$ erfüllbar ist. Die ersten beiden Komponenten würden $a=b=0$ erzwingen, was der dritten Komponente widerspricht. Die Schnittgerade der beiden Ebenen berechnet man durch Gleichsetzen der Orstvektoren. Man erhält hier:
 \[
  \MVector{0\\2\\-2}+a\MVector{1\\-2\\1}+b\MVector{4\\0\\-2}=\MVector{a+4b\\2-2a\\-2+a-2b}=\MVector{5+x\\-2x\\1+y}=\MVector{5\\0\\1}+x\MVector{1\\-2\\0}+y\MVector{0\\0\\3}\MDFPeriod
 \]
 ...
 \[
  a+4b=5+x\MDFPaSpace\textrm{und}\MDFPaSpace 2-2a=-2x,
 \]
 aus denen man $a=1+x$ und $b=1$ berechnet. Dies in die dritte Komponente eingesetzt ergibt
 \[
  -2 + (1+x) - 2\cdot 1=1+y\MDFPSpace\Leftrightarrow\MDFPSpace y=x-4.
 \]
 Nun kann $y=x-4$ oder $a=1+x$ und $b=1$ in die Ebene $G$ oder $E$ eingesetzt werden, dies führt auf zwei mögliche Parameterdarstellung der gleichen Geraden $h$, nämlich der Schnittgeraden der beiden Ebenen. Zum Beispiel für das Einsetzen in $G$ ergibt sich:
 \[
  h\colon\MVec{r}=\MVector{5\\0\\1}+x\MVector{1\\-2\\0}+(x-4)\MVector{0\\0\\3}=\MVector{5\\0\\-11}+x\MVector{1\\-2\\3};\MDFPaSpace x\in\R\MDFPeriod
 \]
...
\[
 E\colon\MVec{r}=\MVector{-1\\3\\0}+a\MVector{2\\-5\\8}+b\MVector{0\\-1\\4};\MDFPaSpace a,b\in\R
\]
und
\[
 F\colon\MVec{r}=\MVector{5\\0\\0}+c\MVector{-2\\3\\x}+d\MVector{2\\y\\12};\MDFPaSpace c,d\in\R,
\]
...
\[
 \MVector{-2\\3\\x}=a\MVector{2\\-5\\8}+b\MVector{0\\-1\\4}.
\]
...
\[
 \MVector{2\\y\\12}=a\MVector{2\\-5\\8}+b\MVector{0\\-1\\4}.
\]
...
Gegeben sind die beiden Ebenen 
\[
 E\colon\MVec{r}=a\MVector{2\\-5\\8}+b\MVector{0\\-1\\4};\MDFPaSpace a,b\in\R
\]
und
\[
 F\colon\MVec{r}=c\MVector{0\\3\\4}+d\MVector{2\\-1\\0};\MDFPaSpace c,d\in\R,
\]
welche sich schneiden und die Schnittgerade
\[
 g\colon\MVec{r}=\xi\MVector{4\\x\\y};\MDFPaSpace \xi\in\R.
\]


Bestimmen Sie die fehlenden Komponenten $x$ und $y$ des Richtungsvektors der Schnittgerade.\\
$x=$\MLFunctionQuestion{10}{-14}{5}{x}{5}{GNATZ3}\\
$y=$\MLFunctionQuestion{10}{-16}{5}{x}{5}{GNATZ4}

\begin{MHint}{Lösung}
Gleichsetzen der Ortsvektoren der beiden Ebenen führt auf
\[
 a\MVector{2\\-5\\8}+b\MVector{0\\-1\\4}=\MVector{2a\\-5a-b\\8a+4b}=\MVector{2d\\3c-d\\4c}=c\MVector{0\\3\\4}+d\MVector{2\\-1\\0}.
\]
Lösen des zugehörigen Gleichungssystems mit $d$ als Parameter führt auf $a=d$, $b=2d$ und $c=-2d$. Die Bedingung $c=-2d$ in die Ebene $F$ eingesetzt führt auf
\[
 -2d\MVector{0\\3\\4}+d\MVector{2\\-1\\0}=d\MVector{2\\-7\\-8}.
\]
Ein geeigneter Richtungsvektor für die Schnittgerade ist also $\MVector{2\\-7\\-8}$. Der Richtungsvektor in der angegebenen Parameterform von $g$ hat als erste Komponente allerdings eine $4$ ist zu diesem Vektor also kollinear, dies führt auf den Vektor $\MVector{4\\-14\\-16}$, als Richtungsvektor, also $x=-14$ und $y=-16$. 
\end{MHint}
...
\item{Violetter Vektor: \MLFunctionQuestion{15}{(-1,2)}{5}{x}{5}{OR20}.} 
...
$$
\MVec{r} \;=\; \MVector{1\\1\\2}+\alpha\cdot \MVector{1\\1\\1};\MDFPSpace\alpha\in\R\;\; \text{und}\;\;
\MVec{r} \;=\; \MVector{0\\1\\-2}+\beta\cdot \MVector{-2\\-4\\4};\MDFPSpace\beta\in\R\: .
$$
\begin{MExerciseItems}
\item{Der Ortsevktor des Schnittpunkts ist $\MDVec{S}=$\MLFunctionQuestion{15}{(-1,-1,0)}{5}{x}{5}{FKT4}.}
