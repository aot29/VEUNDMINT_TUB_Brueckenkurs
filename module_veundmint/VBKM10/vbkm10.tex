...
\begin{itemize}
\item{dem Abschnitt \MNRef{VBKM10_PfeilVektor}, \MSRef{VBKM10_PfeilVektor}{Vom Pfeil zum Vektor},}
\item{dem Abschnitt \MNRef{VBKM10_GeradenEbenen}, \MSRef{VBKM10_GeradenEbenen}{Geraden und Ebenen},}
\item{dem \MSRef{VBKM10_Abschlusstest}{Abschlusstest}, \MNRef{VBKM10_Abschlusstest}.}
\end{itemize}
...
\begin{tabular}{lll}
\MCheckbox{1}{VEC22} & \MBlank & $\MDVec{P}+(\MDVec{P Q}+\MDVec{Q R})$\\
\MCheckbox{0}{VEC23} & \MBlank & $\MDVec{P R}$\\
\MCheckbox{0}{VEC24} & \MBlank & $\MDVec{Q R}$\\
\MCheckbox{1}{VEC25} & \MBlank & $\MDVec{O R}$\\
\MCheckbox{1}{VEC26} & \MBlank & $\MDVec{R}$\\
\MCheckbox{1}{VEC27} & \MBlank & $\MDVec{Q}+\MDVec{Q R}$\\
\end{tabular}
\end{MQuestionGroup}
...
\begin{MQuestionGroup}
\begin{tabular}{lll}
\MCheckbox{0}{INTER1} & \MBlank & die beiden Richtungsvektoren kollinear sind,\\
\MCheckbox{0}{INTER2} & \MBlank & die beiden Richungsvektoren nicht kollinear sind,\\
\MCheckbox{0}{INTER3} & \MBlank & die beiden Richtungsvektoren kollinear sind und die Geraden einen gemeinsamen Punkt besitzen,\\
\MCheckbox{1}{INTER4} & \MBlank & die beiden Richungsvektoren nicht kollinear sind und die Geraden einen gemeinsamen Punkt besitzen,\\
\MCheckbox{0}{INTER5} & \MBlank & die beiden Richungsvektoren nicht kollinear sind und die Geraden keinen gemeinsamen Punkt besitzen.\\
\end{tabular}
\end{MQuestionGroup}
\MGroupButton{Antworten kontrollieren}
