...
\MCheckbox{0}{INTER2} & \MBlank & die beiden Richtungsvektoren nicht kollinear sind,\\
\MCheckbox{0}{INTER3} & \MBlank & die beiden Richtungsvektoren kollinear sind und die Geraden einen gemeinsamen Punkt besitzen,\\
\MCheckbox{1}{INTER4} & \MBlank & die beiden Richtungsvektoren nicht kollinear sind und die Geraden einen gemeinsamen Punkt besitzen,\\
\MCheckbox{0}{INTER5} & \MBlank & die beiden Richtungsvektoren nicht kollinear sind und die Geraden keinen gemeinsamen Punkt besitzen.\\
\end{tabular}
\end{MQuestionGroup}
\MGroupButton{Antworten kontrollieren}
