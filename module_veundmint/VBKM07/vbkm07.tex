...
\begin{tabular}{lll}
\MLCheckbox{0}{JCA1}{CHECKBOXJCA1} & \ \ & $y$-Achsensymmtrisch,\\
\MLCheckbox{0}{JCA2}{CHECKBOXJCA2} & \ \ & Punktsymmetrisch zum Ursprung.
\end{tabular}
\end{MQuestionGroup}
...
\begin{tabular}{lll}
\MLCheckbox{0}{JCC1}{CHECKBOXJCC1} & \ \ & sind konstant,\\
\MLCheckbox{1}{JCC2}{CHECKBOXJCC2} & \ \ & nehmen um $3$ zu,\\
\MLCheckbox{0}{JCC3}{CHECKBOXJCC3} & \ \ & nehmen ab.
\end{tabular}
\ \\

Die Funktion $f$ hat an der Stelle $0$\\
\begin{tabular}{lll}
\MLCheckbox{0}{JCC4}{CHECKBOXJCC4} & \ \ & eine Sprungstelle,\\
\MLCheckbox{0}{JCC5}{CHECKBOXJCC5} & \ \ & keine Ableitung,\\
\MLCheckbox{1}{JCC6}{CHECKBOXJCC6} & \ \ & die Ableitung $1$.
\end{tabular}
\end{MExercise}
