...
\begin{itemize}
\item{\MNRef{M07_Ableitung}, \MSRef{M07_Ableitung}{Ableitung einer Funktion},}
\item{\MNRef{M07_Standardableitungen}, \MSRef{M07_Standardableitungen}{Standardableitungen},}
\item{\MNRef{M07_Rechenregeln}, \MSRef{M07_Rechenregeln}{Rechenregeln},}
\item{\MNRef{M07_Eigenschaften}, \MSRef{M07_Eigenschaften}{Eigenschaften von Funktionen},}
\item{\MNRef{M07_Anwendungen}, \MSRef{M07_Anwendungen}{Anwendungen},}
%\item{\MNRef{M07_Zusammenfassung}, \MSRef{M07_Zusammenfassung}{Zusammenfassung},}
\item{\MNRef{M07_Abschlusstest}, \MSRef{M07_Abschlusstest}{Abschlusstest}.}
\end{itemize}
...
\begin{MXContent}{Zweite Ableitung und Kr"ummungseigenschaften}{Zweite Ableitung und Krümmungseigenschaften}{STD}
...
\begin{MXInfo}{Kr"ummungseigenschaften}
 Ist ${f'}'(x) \geq 0$ f"ur alle $x$ zwischen $a$ und $b$, dann hei{\ss}t $f$ auf dem Intervall $\MoIl a\MIntvlSep b\MoIr$ \textbf{konvex}
 (\textbf{linksgekrümmt}).

 Ist ${f'}'(x) \leq 0$ f"ur alle $x$ zwischen $a$ und $b$, dann hei{\ss}t $f$ auf dem Intervall $\MoIl a\MIntvlSep b\MoIr$ \textbf{konkav}
...
\begin{tabular}{lll}
\MCheckbox{0}{JCA1} & \ \ & achsensymmetrisch zur $y$-Achse,\\
