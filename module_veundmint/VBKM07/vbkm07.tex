...
F"ur $n\in\mathbb{N}$ werden durch $f(x) = x^{\frac{1}{n}}$ Wurzelfunktionen beschrieben. Die hier wiedergegebene Ableitungsregel gilt natürlich auch für $n = 1$ oder $n = -1$, da sie f\"ur ganze Zahlen g\"ultig ist. %###
\begin{MExample}
...
\begin{MExercise}
Berechnen Sie die Ableitungen der Funktionen $f,g$ und $h$ mit den gegebenen Funktionstermen und fassen Sie soweit wie m\"oglich zusammen: %###
\begin{MExerciseItems}
\item $f(x) := \MEU^{5 x}$
