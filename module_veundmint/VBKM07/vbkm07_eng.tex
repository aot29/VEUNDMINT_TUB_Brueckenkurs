...
$60\MEinheit{km}/\MEinheit[]{h}$ roadworks. The sign
...
Using the formula for the relative rate of change, calculating the derivative can be very cumbersome and also only works for very simple functions. Typically, 
