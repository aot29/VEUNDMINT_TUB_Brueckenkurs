...
\item{\MConfigbox{CF_TESTS} Lösungen werden anonym kommuniziert.}
\end{itemize}
\begin{html}
<div class="xreply">
<p id="CHECKIS">
...
\ \\ \ \\
Bei Aktivierung der Datenspeicherung werden die Kursdaten (insbesondere eingegebene Lösungen) in Ihrem Browser gespeichert.
Die Daten liegen auf Ihrem Rechner vor und werden nicht über das Internet versendet. Die Daten sind daher nicht sichtbar, wenn Sie sich
