...
<p>
<script>
rouletteExercise("Grundrechenarten");
</script>
</p>
...
<div class="loginbox">
<p>
Dies ist die Korrektorenversion des Kurses, bitte registrieren Sie sich (falls noch nicht geschehen)
zur Korrektur auf der Einstellungsseite. In der Korrekturversion werden die Nutzerdaten nur im Browser auf diesem
Rechner gespeichert und es wird kein Passwort eingetragen. Falls Sie von einem anderen Rechner zugreifen, müssen Sie
die Nutzerdaten neu eingeben.
<br /><br />
Korrekturhinweise zu einem Objekt werden
durch Klick auf den Meldungsbutton jeweils unter dem Objekt verschickt, zudem gibt es am Ende jeder Seite
einen allgemeinen Meldungsbutton zur gesamten Seite. Bei Problemen wenden Sie sich bitte
an <a href="mailto:daniel.haase@kit.edu">daniel.haase@kit.edu</a> oder benutzen Sie den allgemeinen
Feedbackbutton auf der linken Seite.
<br />
<br />
Die Meldungsbuttons verziehen insbesondere bei eingebetteten Grafiken den Layout
in der Korrekturversion, bitte melden Sie daher keine Layoutfehler die durch diese Buttons
oder durch folgende Zeilenwechsel verursacht werden.
<br /><br />
</p>
</div>
